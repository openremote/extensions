...
public abstract class ElectricityAsset<T extends ElectricityAsset<?>> extends Asset<T> {
  ...
  public static final AttributeDescriptor<Double> POWER =
      new AttributeDescriptor<>("power", ValueType.NUMBER, new MetaItem<>(MetaItemType.READ_ONLY))
          .withUnits(UNITS_KILO, UNITS_WATT);
  public static final AttributeDescriptor<Double> POWER_SETPOINT =
      new AttributeDescriptor<>("powerSetpoint", ValueType.NUMBER)
          .withUnits(UNITS_KILO, UNITS_WATT)
          .withOptional(true);
  public static final AttributeDescriptor<Double> POWER_IMPORT_MIN =
      new AttributeDescriptor<>("powerImportMin", ValueType.POSITIVE_NUMBER)
          .withUnits(UNITS_KILO, UNITS_WATT);
  public static final AttributeDescriptor<Double> POWER_IMPORT_MAX =
      new AttributeDescriptor<>("powerImportMax", ValueType.POSITIVE_NUMBER)
          .withUnits(UNITS_KILO, UNITS_WATT);
  public static final AttributeDescriptor<Double> POWER_EXPORT_MIN =
      new AttributeDescriptor<>("powerExportMin", ValueType.POSITIVE_NUMBER)
          .withUnits(UNITS_KILO, UNITS_WATT);
  public static final AttributeDescriptor<Double> POWER_EXPORT_MAX =
      new AttributeDescriptor<>("powerExportMax", ValueType.POSITIVE_NUMBER)
          .withUnits(UNITS_KILO, UNITS_WATT);
  ...
  public static final AttributeDescriptor<Integer> EFFICIENCY_IMPORT =
      new AttributeDescriptor<>("efficiencyImport", ValueType.POSITIVE_INTEGER)
