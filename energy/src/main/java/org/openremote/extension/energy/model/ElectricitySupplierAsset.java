...
public class ElectricitySupplierAsset extends ElectricityAsset<ElectricitySupplierAsset> {
  ...
  public static final AttributeDescriptor<Double> FINANCIAL_COST =
      new AttributeDescriptor<>("financialCost", ValueType.NUMBER).withUnits("EUR");
  public static final AttributeDescriptor<Double> CARBON_COST =
      new AttributeDescriptor<>(
              "carbonCost", ValueType.NUMBER, new MetaItem<>(MetaItemType.READ_ONLY))
          .withUnits(UNITS_KILO, UNITS_GRAM);
  public static final AttributeDescriptor<Double> ENERGY_LOCAL =
      new AttributeDescriptor<>("energyLocal", NUMBER, new MetaItem<>(MetaItemType.READ_ONLY))
          .withUnits(UNITS_KILO, UNITS_WATT, UNITS_HOUR);
  public static final AttributeDescriptor<Double> ENERGY_RENEWABLE_SHARE =
      new AttributeDescriptor<>(
              "energyRenewableShare", NUMBER, new MetaItem<>(MetaItemType.READ_ONLY))
          .withUnits(UNITS_PERCENTAGE);
  public static final AttributeDescriptor<Double> ENERGY_SELF_CONSUMPTION =
      new AttributeDescriptor<>(
              "energySelfConsumption", NUMBER, new MetaItem<>(MetaItemType.READ_ONLY))
          .withUnits(UNITS_PERCENTAGE);
  public static final AttributeDescriptor<Double> ENERGY_AUTARKY =
      new AttributeDescriptor<>("energyAutarky", NUMBER, new MetaItem<>(MetaItemType.READ_ONLY))
          .withUnits(UNITS_PERCENTAGE);

  public static final AttributeDescriptor<Double> POWER_SETPOINT =
      ElectricityAsset.POWER_SETPOINT.withOptional(true);
  public static final AttributeDescriptor<Double> POWER_IMPORT_MIN =
      ElectricityAsset.POWER_IMPORT_MIN.withOptional(true);
  public static final AttributeDescriptor<Double> POWER_EXPORT_MAX =
      ElectricityAsset.POWER_EXPORT_MAX.withOptional(true);
  public static final AttributeDescriptor<Double> POWER_EXPORT_MIN =
      ElectricityAsset.POWER_EXPORT_MIN.withOptional(true);
  public static final AttributeDescriptor<Integer> EFFICIENCY_IMPORT =
      ElectricityAsset.EFFICIENCY_IMPORT.withOptional(true);
  public static final AttributeDescriptor<Integer> EFFICIENCY_EXPORT =
      ElectricityAsset.EFFICIENCY_EXPORT.withOptional(true);
  public static final AttributeDescriptor<Double> TARIFF_IMPORT =
      ElectricityAsset.TARIFF_IMPORT.withOptional(false);
  public static final AttributeDescriptor<Double> TARIFF_EXPORT =
      ElectricityAsset.TARIFF_EXPORT.withOptional(false);

  public static final AssetDescriptor<ElectricitySupplierAsset> DESCRIPTOR =
      new AssetDescriptor<>("upload-network", "9257A9", ElectricitySupplierAsset.class);
  public static final AttributeDescriptor<Double> CARBON_IMPORT =
      new AttributeDescriptor<>("carbonImport", ValueType.NUMBER)
          .withUnits(UNITS_KILO, UNITS_GRAM, UNITS_PER, UNITS_KILO, UNITS_WATT, UNITS_HOUR)
          .withOptional(false);
  public static final AttributeDescriptor<Double> CARBON_EXPORT =
      new AttributeDescriptor<>("carbonExport", ValueType.NUMBER)
          .withUnits(UNITS_KILO, UNITS_GRAM, UNITS_PER, UNITS_KILO, UNITS_WATT, UNITS_HOUR)
          .withOptional(false);
