...
public class ElectricityProducerWindAsset extends ElectricityProducerAsset {
  ...
  public static final AttributeDescriptor<Double> WIND_SPEED_REFERENCE =
      new AttributeDescriptor<>("windSpeedReference", ValueType.POSITIVE_NUMBER)
          .withUnits(UNITS_METRE, UNITS_PER, UNITS_SECOND);
  public static final AttributeDescriptor<Double> WIND_SPEED_MIN =
      new AttributeDescriptor<>("windSpeedMin", ValueType.POSITIVE_NUMBER)
          .withUnits(UNITS_METRE, UNITS_PER, UNITS_SECOND);
  public static final AttributeDescriptor<Double> WIND_SPEED_MAX =
      new AttributeDescriptor<>("windSpeedMax", ValueType.POSITIVE_NUMBER)
          .withUnits(UNITS_METRE, UNITS_PER, UNITS_SECOND);

  public static final AttributeDescriptor<Boolean> INCLUDE_FORECAST_WIND_SERVICE =
      new AttributeDescriptor<>("includeForecastWindService", BOOLEAN);

  public static final AttributeDescriptor<Boolean> SET_ACTUAL_WIND_VALUE_WITH_FORECAST =
      new AttributeDescriptor<>("setWindActualValueWithForecast", BOOLEAN);

  public static final AssetDescriptor<ElectricityProducerWindAsset> DESCRIPTOR =
      new AssetDescriptor<>("wind-turbine", "4B87EA", ElectricityProducerWindAsset.class);
  ...
  public Optional<Boolean> isSetActualWindValueWithForecast() {
    return getAttribute(SET_ACTUAL_WIND_VALUE_WITH_FORECAST)
