...
public class ElectricVehicleAsset extends ElectricityBatteryAsset {
  ...
  public static final ValueDescriptor<EnergyType> ENERGY_TYPE_VALUE =
      new ValueDescriptor<>("energyType", EnergyType.class);

  public static final AttributeDescriptor<EnergyType> ENERGY_TYPE =
      new AttributeDescriptor<>("energyType", ENERGY_TYPE_VALUE);
  public static final AttributeDescriptor<ElectricityChargerAsset.ConnectorType> CONNECTOR_TYPE =
      new AttributeDescriptor<>("connectorType", ElectricityChargerAsset.CONNECTOR_TYPE_VALUE);
  public static final AttributeDescriptor<Integer> ODOMETER =
      new AttributeDescriptor<>(
              "odometer", ValueType.POSITIVE_INTEGER, new MetaItem<>(MetaItemType.READ_ONLY))
          .withUnits(UNITS_KILO, UNITS_METRE);
  public static final AttributeDescriptor<Boolean> CHARGER_CONNECTED =
      new AttributeDescriptor<>(
          "chargerConnected", ValueType.BOOLEAN, new MetaItem<>(MetaItemType.READ_ONLY));
  public static final AttributeDescriptor<String> CHARGER_ID =
      new AttributeDescriptor<>(
          "chargerID", ValueType.TEXT, new MetaItem<>(MetaItemType.READ_ONLY));
  public static final AttributeDescriptor<Integer> MILEAGE_CAPACITY =
      new AttributeDescriptor<>("mileageCapacity", ValueType.POSITIVE_INTEGER)
          .withUnits(UNITS_KILO, UNITS_METRE);
  public static final AttributeDescriptor<Double> MILEAGE_CHARGED =
      new AttributeDescriptor<>(
              "mileageCharged", ValueType.POSITIVE_NUMBER, new MetaItem<>(MetaItemType.READ_ONLY))
          .withUnits(UNITS_KILO, UNITS_METRE);
  public static final AttributeDescriptor<Integer> MILEAGE_MIN =
      new AttributeDescriptor<>("mileageMin", ValueType.POSITIVE_INTEGER)
          .withUnits(UNITS_KILO, UNITS_METRE);
  public static final AttributeDescriptor<String> VEHICLE_CATEGORY =
      new AttributeDescriptor<>("vehicleCategory", ValueType.TEXT);

  public static final AssetDescriptor<ElectricVehicleAsset> DESCRIPTOR =
      new AssetDescriptor<>("car-electric", "49B0D8", ElectricVehicleAsset.class);
