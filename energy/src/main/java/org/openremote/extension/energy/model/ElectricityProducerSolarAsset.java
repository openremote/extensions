...
public class ElectricityProducerSolarAsset extends ElectricityProducerAsset {
  ...
  public static final ValueDescriptor<PanelOrientation> PANEL_ORIENTATION_VALUE =
      new ValueDescriptor<>("panelOrientation", PanelOrientation.class);

  public static final AttributeDescriptor<PanelOrientation> PANEL_ORIENTATION =
      new AttributeDescriptor<>("panelOrientation", PANEL_ORIENTATION_VALUE);
  public static final AttributeDescriptor<Integer> PANEL_AZIMUTH =
      new AttributeDescriptor<>("panelAzimuth", ValueType.INTEGER).withUnits(UNITS_DEGREE);
  public static final AttributeDescriptor<Integer> PANEL_PITCH =
      new AttributeDescriptor<>("panelPitch", ValueType.POSITIVE_INTEGER).withUnits(UNITS_DEGREE);

  public static final AttributeDescriptor<Boolean> INCLUDE_FORECAST_SOLAR_SERVICE =
      new AttributeDescriptor<>("includeForecastSolarService", BOOLEAN);

  public static final AttributeDescriptor<Boolean> SET_ACTUAL_SOLAR_VALUE_WITH_FORECAST =
      new AttributeDescriptor<>("setActualSolarValueWithForecast", BOOLEAN);

  public static final AssetDescriptor<ElectricityProducerSolarAsset> DESCRIPTOR =
      new AssetDescriptor<>("white-balance-sunny", "EABB4D", ElectricityProducerSolarAsset.class);
  ...
  public Optional<Boolean> isSetActualSolarValueWithForecast() {
    return getAttribute(SET_ACTUAL_SOLAR_VALUE_WITH_FORECAST)
