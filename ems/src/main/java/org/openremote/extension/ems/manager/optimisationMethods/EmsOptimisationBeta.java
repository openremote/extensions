...
public class EmsOptimisationBeta implements OptimisationMethod {
  protected static final Logger LOG =
      SyslogCategory.getLogger(DATA, EmsOptimisationBeta.class.getName());
  ...
  private Map<String, Integer> batteryCalculateForecasts(
    ...
    for (EmsElectricityBatteryAsset electricityBatteryAsset : electricityBatteryAssets) {
      ...
      //            System.out.println("chargePercentageAvailableBatteryList2 = " +
      // chargePercentageAvailableBatteryList);
      //            System.out.println("dischargePercentageAvailableBatteryList2 = " +
      // dischargePercentageAvailableBatteryList);
      ...
      if (getToLimitPercentage > energyLevelPercentageMaximumBattery
        ...
        //                System.out.println("energyLevelPredictionListOptimisedLimits = " +
        // energyLevelPredictionList + "\n");
      ...
      //            System.out.println("energyLevelPredictionListOptimisedLimitsAndTariffs = " +
      // energyLevelPredictionList + "\n");
