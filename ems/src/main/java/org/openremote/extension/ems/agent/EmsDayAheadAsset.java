...
public class EmsDayAheadAsset extends Asset<EmsDayAheadAsset> {
  ...
  public static final AttributeDescriptor<String> COLLECT_TIME_FORECASTS =
      new AttributeDescriptor<>("collectTimeForecasts", ValueType.TEXT);

  public static final AttributeDescriptor<String> LAST_UPDATE_FORECASTS =
  ...
  public static final AttributeDescriptor<Double> TARIFF_IMPORT_DAY_AHEAD =
      new AttributeDescriptor<>(
  ...
  public static final AttributeDescriptor<Boolean> USE_TARIFF_DAY_AHEAD_FORECASTS =
      new AttributeDescriptor<>("useTariffDayAheadForecasts", ValueType.BOOLEAN);

  public static final AssetDescriptor<EmsDayAheadAsset> DESCRIPTOR =
      new AssetDescriptor<>("calendar-clock", "000000", EmsDayAheadAsset.class);
