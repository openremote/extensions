...
public class EmsEnergyOptimisationAsset extends Asset<EmsEnergyOptimisationAsset> {
  ...
  public static final AttributeDescriptor<String> ADVANCED_SETTINGS_ATTRIBUTES =
  ...
  public static final AttributeDescriptor<Boolean> ENABLE_DETAILED_LOGGING =
      new AttributeDescriptor<>("enableDetailedLogging", ValueType.BOOLEAN);
  ...
  public static final AttributeDescriptor<Boolean>
      GENERATE_POWER_LIMIT_MAXIMUM_PROFILE_MANUAL_INPUT =
          new AttributeDescriptor<>(
              "generatePowerLimitMaximumProfileManualInput", ValueType.BOOLEAN);

  public static final AttributeDescriptor<Boolean>
      GENERATE_POWER_LIMIT_MINIMUM_PROFILE_MANUAL_INPUT =
          new AttributeDescriptor<>(
              "generatePowerLimitMinimumProfileManualInput", ValueType.BOOLEAN);

  public static final AttributeDescriptor<Boolean> DISABLE_OPTIMISATION_SERVICE =
      new AttributeDescriptor<>("disableOptimisationService", ValueType.BOOLEAN);
  ...
  public static final ValueDescriptor<OptimisationMethodValueType> OPTIMISATION_METHOD_VALUE_TYPE =
      new ValueDescriptor<>("optimisationMethodValueType", OptimisationMethodValueType.class);

  public static final AttributeDescriptor<OptimisationMethodValueType> OPTIMISATION_METHOD =
      new AttributeDescriptor<>("optimisationMethod", OPTIMISATION_METHOD_VALUE_TYPE);

  public static final AttributeDescriptor<Double> POWER_CONSUMPTION =
      new AttributeDescriptor<>(
              "powerConsumption",
              ValueType.NUMBER,
  ...
  public static final AttributeDescriptor<Double> POWER_FLEXIBLE =
      new AttributeDescriptor<>(
              "powerFlexible",
              ValueType.NUMBER,
              new MetaItem<>(MetaItemType.HAS_PREDICTED_DATA_POINTS),
  ...
  public static final AttributeDescriptor<Double> POWER_NET =
      new AttributeDescriptor<>(
              "powerNet",
              ValueType.NUMBER,
              new MetaItem<>(MetaItemType.HAS_PREDICTED_DATA_POINTS),
  ...
  public static final AttributeDescriptor<Double> POWER_PRODUCTION =
      new AttributeDescriptor<>(
              "powerProduction",
              ValueType.NUMBER,
              new MetaItem<>(MetaItemType.HAS_PREDICTED_DATA_POINTS),
  ...
  public static final AttributeDescriptor<Double> POWER_LIMIT_MAXIMUM_INPUT =
      new AttributeDescriptor<>("powerLimitMaximumInput", ValueType.NUMBER)
          .withUnits(UNITS_KILO, UNITS_WATT);

  public static final AttributeDescriptor<Double> POWER_LIMIT_MAXIMUM_PROFILE_MANUAL =
      new AttributeDescriptor<>(
  ...
  public static final AttributeDescriptor<String> POWER_LIMIT_MAXIMUM_PROFILE_MANUAL_INPUT =
      new AttributeDescriptor<>(
          "powerLimitMaximumProfileManualInput",
          ValueType.TEXT,
          new MetaItem<>(MetaItemType.MULTILINE));

  public static final AttributeDescriptor<Double> POWER_LIMIT_MAXIMUM_PROFILE_TOTAL =
      new AttributeDescriptor<>(
  ...
  public static final AttributeDescriptor<Double> POWER_LIMIT_MINIMUM_INPUT =
      new AttributeDescriptor<>("powerLimitMinimumInput", ValueType.NUMBER)
          .withUnits(UNITS_KILO, UNITS_WATT);

  public static final AttributeDescriptor<Double> POWER_LIMIT_MINIMUM_PROFILE_MANUAL =
      new AttributeDescriptor<>(
  ...
  public static final AttributeDescriptor<String> POWER_LIMIT_MINIMUM_PROFILE_MANUAL_INPUT =
      new AttributeDescriptor<>(
          "powerLimitMinimumProfileManualInput",
          ValueType.TEXT,
          new MetaItem<>(MetaItemType.MULTILINE));

  public static final AttributeDescriptor<Double> POWER_LIMIT_MINIMUM_PROFILE_TOTAL =
      new AttributeDescriptor<>(
  ...
  public static final AssetDescriptor<EmsEnergyOptimisationAsset> DESCRIPTOR =
      new AssetDescriptor<>("flash", "C4DB0D", EmsEnergyOptimisationAsset.class);
  ...
  public Optional<String> getPowerLimitMaximumProfileManualInput() {
    return getAttribute(POWER_LIMIT_MAXIMUM_PROFILE_MANUAL_INPUT)
        .flatMap(AbstractNameValueHolder::getValue);
  }

  public Optional<Double> getPowerLimitMaximumProfileTotal() {
    return getAttribute(POWER_LIMIT_MAXIMUM_PROFILE_TOTAL)
        .flatMap(AbstractNameValueHolder::getValue);
  }
  ...
  public Optional<String> getPowerLimitMinimumProfileManualInput() {
    return getAttribute(POWER_LIMIT_MINIMUM_PROFILE_MANUAL_INPUT)
        .flatMap(AbstractNameValueHolder::getValue);
  }

  public Optional<Double> getPowerLimitMinimumProfileTotal() {
    return getAttribute(POWER_LIMIT_MINIMUM_PROFILE_TOTAL)
        .flatMap(AbstractNameValueHolder::getValue);
  }
