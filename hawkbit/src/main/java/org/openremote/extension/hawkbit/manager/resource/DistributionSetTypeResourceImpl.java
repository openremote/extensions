...
public class DistributionSetTypeResourceImpl extends HawkbitWebResource
  ...
  public DistributionSetTypeResourceImpl(
  ...
  @Override
  public Response createDistributionSetType(
      RequestParams requestParams, String realm, JsonNode distributionSetType) {
    requireHawkbitRealmAccess(realm);
    return HawkbitResponseProxy.proxy(
        "Failed to create firmware distribution set type",
        () -> hawkbitFirmwareService.distributionSetTypes().create(distributionSetType));
  }

  @Override
  public Response getDistributionSetTypes(
      RequestParams requestParams, String realm, Integer offset, Integer limit) {
    requireHawkbitRealmAccess(realm);
    return HawkbitResponseProxy.proxy(
        "Failed to retrieve firmware distribution set types",
  ...
  public Response getDistributionSetType(RequestParams requestParams, String realm, Long id) {
    requireHawkbitRealmAccess(realm);
    return HawkbitResponseProxy.proxy(
        "Failed to retrieve firmware distribution set type '" + id + "'",
        () -> hawkbitFirmwareService.distributionSetTypes().get(id));
  }

  @Override
  public Response getMandatoryModuleTypes(
    ...
    return HawkbitResponseProxy.proxy(
        ...
        () ->
            hawkbitFirmwareService
                ...
                .getMandatoryModuleTypes(id, offset, limit));
  }

  @Override
  public Response getOptionalModuleTypes(
      RequestParams requestParams, String realm, Long id, Integer offset, Integer limit) {
    requireHawkbitRealmAccess(realm);
    return HawkbitResponseProxy.proxy(
        ...
        () ->
            hawkbitFirmwareService
                .distributionSetTypes()
                .getOptionalModuleTypes(id, offset, limit));
  }
  ...
  public Response deleteDistributionSetType(RequestParams requestParams, String realm, Long id) {
    requireHawkbitRealmAccess(realm);
    return HawkbitResponseProxy.proxy(
        "Failed to delete firmware distribution set type '" + id + "'",
