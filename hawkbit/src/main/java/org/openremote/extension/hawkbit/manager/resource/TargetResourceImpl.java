...
public class TargetResourceImpl extends HawkbitWebResource implements TargetResource {
  ...
  public Response getTargets(
      RequestParams requestParams, String realm, String query, Integer offset, Integer limit) {
    requireHawkbitRealmAccess(realm);
    return HawkbitResponseProxy.proxy(
        "Failed to retrieve firmware targets",
  ...
  public Response getTarget(RequestParams requestParams, String realm, String id) {
    requireHawkbitRealmAccess(realm);
    return HawkbitResponseProxy.proxy(
        "Failed to retrieve firmware target '" + id + "'",
  ...
  public Response deleteTarget(RequestParams requestParams, String realm, String id) {
    requireHawkbitRealmAccess(realm);
    return HawkbitResponseProxy.proxy(
        "Failed to delete firmware target '" + id + "'",
  ...
  public Response getMetadata(RequestParams requestParams, String realm, String id) {
    requireHawkbitRealmAccess(realm);
    return HawkbitResponseProxy.proxy(
        "Failed to retrieve metadata for firmware target '" + id + "'",
  ...
  public Response getAssignedDs(RequestParams requestParams, String realm, String id) {
    requireHawkbitRealmAccess(realm);
    return HawkbitResponseProxy.proxy(
        "Failed to retrieve assigned DS for firmware target '" + id + "'",
  ...
  public Response getInstalledDs(RequestParams requestParams, String realm, String id) {
    requireHawkbitRealmAccess(realm);
    return HawkbitResponseProxy.proxy(
        "Failed to retrieve installed DS for firmware target '" + id + "'",
        () -> hawkbitFirmwareService.targets().getInstalledDs(id));
  }

  @Override
  public Response getActions(
      RequestParams requestParams, String realm, String id, Integer offset, Integer limit) {
    requireHawkbitRealmAccess(realm);
    return HawkbitResponseProxy.proxy(
        "Failed to retrieve actions for firmware target '" + id + "'",
  ...
  public Response cancelAction(
      RequestParams requestParams, String realm, String id, Long actionId, Boolean force) {
    requireHawkbitRealmAccess(realm);
    return HawkbitResponseProxy.proxy(
