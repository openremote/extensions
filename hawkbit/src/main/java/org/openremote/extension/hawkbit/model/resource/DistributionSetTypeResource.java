 ...
 *
 * <p>Delegates to {@link
 * org.openremote.extension.hawkbit.manager.hawkbit.HawkbitDistributionSetTypesClient} and returns
 * the upstream response body unchanged.
 */
@Tag(
    name = "Firmware Distribution Set Types",
    description = "Management of firmware distribution set types")
...
public interface DistributionSetTypeResource {
  ...
  Response createDistributionSetType(
  ...
  Response getDistributionSetTypes(
      @BeanParam RequestParams requestParams,
      @QueryParam("realm") String realm,
  ...
  @Produces(APPLICATION_JSON)
  @RolesAllowed({Constants.READ_ADMIN_ROLE})
  Response getDistributionSetType(
      @BeanParam RequestParams requestParams,
      @QueryParam("realm") String realm,
   ...
   *
   * <p>Describes the composition contract of the DS type, not the modules of any specific
   * distribution set.
   */
  @GET
   ...
   *
   * <p>Describes the <em>composition contract</em> of the DS type, not the modules of any specific
   * distribution set. See {@link #getMandatoryModuleTypes}.
   */
  @GET
  @Path("{id}/optionalmoduletypes")
  @Produces(APPLICATION_JSON)
  @RolesAllowed({Constants.READ_ADMIN_ROLE})
  Response getOptionalModuleTypes(
      @BeanParam RequestParams requestParams,
      @QueryParam("realm") String realm,
      @PathParam("id") Long id,
      @QueryParam("offset") Integer offset,
  ...
  @Path("{id}")
  @RolesAllowed({Constants.WRITE_ADMIN_ROLE})
  Response deleteDistributionSetType(
      @BeanParam RequestParams requestParams,
      @QueryParam("realm") String realm,
      @PathParam("id") Long id);
}
