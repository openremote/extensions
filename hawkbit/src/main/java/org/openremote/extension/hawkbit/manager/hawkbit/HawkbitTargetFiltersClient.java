...
@Path("targetfilters")
public interface HawkbitTargetFiltersClient {
  ...
  @DELETE
  @Path("{filterId}")
  Response delete(@PathParam("filterId") Long filterId);
  ...
  @Consumes(APPLICATION_HAL_JSON)
  @Produces(APPLICATION_HAL_JSON)
  Response setAutoAssignDS(@PathParam("filterId") Long filterId, JsonNode request);

  @DELETE
  @Path("{filterId}/autoAssignDS")
  Response deleteAutoAssignDS(@PathParam("filterId") Long filterId);
}
