...
public class RolloutResourceImpl extends HawkbitWebResource implements RolloutResource {

  public RolloutResourceImpl(
  ...
  @Override
  public Response getRollouts(
      RequestParams requestParams, String realm, Integer offset, Integer limit) {
    requireHawkbitRealmAccess(realm);
    // Request full representation so totalTargetsPerStatus and totalGroups are populated; hawkBit
    // defaults to compact.
    return HawkbitResponseProxy.proxy(
        "Failed to retrieve firmware rollouts",
  ...
  public Response getRollout(RequestParams requestParams, String realm, Long id) {
    requireHawkbitRealmAccess(realm);
    return HawkbitResponseProxy.proxy(
        "Failed to retrieve firmware rollout '" + id + "'",
  ...
  public Response createRollout(RequestParams requestParams, String realm, JsonNode rollout) {
    requireHawkbitRealmAccess(realm);
    return HawkbitResponseProxy.proxy(
        "Failed to create firmware rollout",
  ...
  public Response deleteRollout(RequestParams requestParams, String realm, Long id) {
    requireHawkbitRealmAccess(realm);
    return HawkbitResponseProxy.proxy(
        "Failed to delete firmware rollout '" + id + "'",
  ...
  public Response startRollout(RequestParams requestParams, String realm, Long id) {
    requireHawkbitRealmAccess(realm);
    return HawkbitResponseProxy.proxy(
        "Failed to start firmware rollout '" + id + "'",
  ...
  public Response pauseRollout(RequestParams requestParams, String realm, Long id) {
    requireHawkbitRealmAccess(realm);
    return HawkbitResponseProxy.proxy(
        "Failed to pause firmware rollout '" + id + "'",
        () -> hawkbitFirmwareService.rollouts().pause(id));
  }

  @Override
  public Response getRolloutGroups(
      RequestParams requestParams, String realm, Long id, Integer offset, Integer limit) {
    requireHawkbitRealmAccess(realm);
    return HawkbitResponseProxy.proxy(
        "Failed to retrieve groups for rollout '" + id + "'",
        () -> hawkbitFirmwareService.rollouts().getRolloutGroups(id, offset, limit, "full"));
  }

  @Override
  public Response getRolloutGroup(
      RequestParams requestParams, String realm, Long id, Long groupId) {
    requireHawkbitRealmAccess(realm);
    return HawkbitResponseProxy.proxy(
